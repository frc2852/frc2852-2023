...
public class AutoBalancePigeon {
    ...
    private double[] ypr = new double[3]; // yaw-pitch-roll angles

    public AutoBalancePigeon() {
        pigeonIMU = new PigeonIMU(Constants.PIGEON_IMU);
        state = 0;
        debounceCount = 0;
    ...
    // to.
    public double autoBalanceRoutine(boolean reverseDrive) {
        switch (state) {
            ...
            case 0:
                ...
                if (debounceCount > secondsToTicks(debounceTime)) {
                    state = 1;
                    debounceCount = 0;
                    return reverseDrive ? -robotSpeedSlow : robotSpeedSlow;
                }
                
                return reverseDrive ? -robotSpeedFast : robotSpeedFast;
