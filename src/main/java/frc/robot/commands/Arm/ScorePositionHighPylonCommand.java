...
// public class ScorePositionHighPylonCommand extends SequentialCommandGroup {
//   /** Creates a new LowScorePositionCommand. */
//   public ScorePositionHighPylonCommand(ArmSubsystem armSubsystem) {
...
//     addCommands(new OuterArmCommand(armSubsystem, -21, 0));
//     addCommands(new InnerArmCommand(armSubsystem, -72, 0.4));
